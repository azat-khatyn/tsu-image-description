...
На текущем baseline-этапе наилучший результат демонстрируют показатели производительности, а значения BLEU, METEOR и CLIPScore отражают базовый уровень качества до этапа доменного дообучения модели.
