...
Теперь сгенерируй описание. Ответь только текстом описания, без префиксов и комментариев.
Описание:"""
...
Теперь сгенерируй описние. Ответь только текстом описания, без префиксов и комментариев.
Описание:"""
