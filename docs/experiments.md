...
Это задачи по строительству платформы оценки и подготовки данных. **В тезисную таблицу экспериментов они не входят**. Задачи трекаются в `docs/experiments_log.md` отдельным разделом.
